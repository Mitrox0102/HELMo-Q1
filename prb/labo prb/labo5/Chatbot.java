...
public class Chatbot {
	...
	public static void main(String[] args) {
		...
		System.out.println("CHATBOT : Bonjour ! Je suis un chatbot. Comment puis-je vous aider aujourd'hui ?");
		
		String reponse, user;
		
		do {
			user = Console.lireString("VOUS : ");
			
			reponse = choisirReponse(user);
			
			System.out.println("CHATBOT : " + reponse);
			
		} while(!reponse.equals("Au revoir !"));
